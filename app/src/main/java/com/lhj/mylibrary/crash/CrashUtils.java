package com.lhj.mylibrary.crash;
 ...
 * @Description:
 * @Author: liuhuajian
 * @CreateDate: 2019/10/21 9:53
 * @UpdateUser: itwangxiang
 * @UpdateDate: 2019/10/21 9:53
 * @UpdateRemark: 更新说明
 * @Version: 0.2
 */
public class CrashUtils {
    ...
    public static void init(final String crashDirPath, final OnCrashListener onCrashListener) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && App.mContext.getExternalCacheDir() != null)
            defaultDir = App.mContext.getExternalCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        else {
            defaultDir = App.mContext.getCacheDir() + FILE_SEP + "crash" + FILE_SEP;
        }
